...
namespace CourierLogistic.Libs
{
    /// <summary>
    /// Класс PrintWindow
    /// Отвечает за сохранение печатных форм в PDF файл
    /// </summary>
    class PrintWindow
    {
        /// <summary>
        /// Метод GetImage
        /// Получает изображение печатной формы
        /// </summary>
        /// <param name="view"> Выбранная форма </param>
        /// <returns></returns>
        ...
        /// Создает файл PDF из выбранного файла PNG
        /// </summary>
